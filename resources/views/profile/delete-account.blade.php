...
@section('content')
    ...
    <div class="settings-container">
        {{-- {{ $user }} --}}
        <h2 class="settings-header">Delete Account</h2>
        <p class="text-center text-danger">Warning: This action cannot be undone. All your data will be permanently deleted.
        </p>
